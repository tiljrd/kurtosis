...
export interface paths {
    ...
    "/enclaves/{enclave_identifier}/services/{service_identifier}/update": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Update the configuration for a specific service. This includes updating the image, command,
         *     entrypoint, environment variables, ports, and file artifact mounts.
         *
         */
        post: {
            parameters: {
            ...
            responses: {
                /** @description Successful update of the service configuration */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
...
export interface components {
    schemas: {
        ...
        UpdateServiceRequest: {
            ...
            files_artifacts_mounts?: {
                [key: string]: components["schemas"]["FileArtifactMount"] | undefined;
            };
        };
        /** @enum {string} */
