 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.api_container_api.UpdateServiceArgs,
 *   !proto.api_container_api.UpdateServiceResponse>}
 */
const methodDescriptor_ApiContainerService_UpdateService = new grpc.web.MethodDescriptor(
  '/api_container_api.ApiContainerService/UpdateService',
  grpc.web.MethodType.UNARY,
  proto.api_container_api.UpdateServiceArgs,
  proto.api_container_api.UpdateServiceResponse,
  /**
   * @param {!proto.api_container_api.UpdateServiceArgs} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.api_container_api.UpdateServiceResponse.deserializeBinary
);


/**
 * @param {!proto.api_container_api.UpdateServiceArgs} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.api_container_api.UpdateServiceResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.api_container_api.UpdateServiceResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.api_container_api.ApiContainerServiceClient.prototype.updateService =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/api_container_api.ApiContainerService/UpdateService',
      request,
      metadata || {},
      methodDescriptor_ApiContainerService_UpdateService,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.api_container_api.UpdateServiceResponse>}
 *     Promise that resolves to the response
 */
proto.api_container_api.ApiContainerServicePromiseClient.prototype.updateService =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/api_container_api.ApiContainerService/UpdateService',
      request,
